...
class PassengerForm(forms.Form):
    ...
    maxDelay = forms.IntegerField(initial=0,help_text=u'Ce nombre correspond à la fourchette de temps en minutes dans laquelle vous acceptez d\'arrivée à destination. Si vous choisissez 10 minutes, cela signifie que vous acceptez d\'arriver 10 minutes avant ou 10 minutes après l\'heure d\'arrivée rentrée précédemment.')
